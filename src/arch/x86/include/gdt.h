...
static const uint8_t SEGMENT_KERNEL_CODE = SEGMENT_PRESENT | SEGMENT_PRIVLG_0 | SEGMENT_CODE_DATA | SEGMENT_CODE_SEGMENT | SEGMENT_RW_SEGMENT | SEGMENT_ACCESSED;
static const uint8_t SEGMENT_KERNEL_DATA = SEGMENT_PRESENT | SEGMENT_PRIVLG_0 | SEGMENT_CODE_DATA | SEGMENT_RW_SEGMENT | SEGMENT_ACCESSED;
static const uint8_t SEGMENT_USER_CODE = SEGMENT_PRESENT | SEGMENT_PRIVLG_3 | SEGMENT_CODE_DATA | SEGMENT_CODE_SEGMENT | SEGMENT_RW_SEGMENT | SEGMENT_ACCESSED;
static const uint8_t SEGMENT_USER_DATA = SEGMENT_PRESENT | SEGMENT_PRIVLG_3 | SEGMENT_CODE_DATA | SEGMENT_RW_SEGMENT | SEGMENT_ACCESSED;
